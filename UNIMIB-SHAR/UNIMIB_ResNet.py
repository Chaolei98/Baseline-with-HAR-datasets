...
#load data
# train_x = torch.from_numpy(np.load('/data1/experiment/hcl/Datasets/unimib/x_train.npy')).float()
# train_y = torch.from_numpy(np.load('/data1/experiment/hcl/Datasets/unimib/y_train.npy')).long()
# test_x = torch.from_numpy(np.load('/data1/experiment/hcl/Datasets/unimib/x_test.npy')).float()
# test_y = torch.from_numpy(np.load('/data1/experiment/hcl/Datasets/unimib/y_test.npy')).long()
train_x = torch.from_numpy(np.load('/mnt/experiment/hcl/Datasets/unimib/x_train.npy')).float()
train_y = torch.from_numpy(np.load('/mnt/experiment/hcl/Datasets/unimib/y_train.npy')).long()
test_x = torch.from_numpy(np.load('/mnt/experiment/hcl/Datasets/unimib/x_test.npy')).float()
test_y = torch.from_numpy(np.load('/mnt/experiment/hcl/Datasets/unimib/y_test.npy')).long()
...
class ResNet(nn.Module):
    def __init__(self, input_channel, num_classes):
        ...
        self.fc = nn.Linear(256*5*3, num_classes)
