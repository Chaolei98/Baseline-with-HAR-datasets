...
#load data
train_x = torch.from_numpy(np.load('/Datasets/unimib/x_train.npy')).float()
train_y = torch.from_numpy(np.load('/Datasets/unimib/y_train.npy')).long()
test_x = torch.from_numpy(np.load('/Datasets/unimib/x_test.npy')).float()
test_y = torch.from_numpy(np.load('/Datasets/unimib/y_test.npy')).long()
