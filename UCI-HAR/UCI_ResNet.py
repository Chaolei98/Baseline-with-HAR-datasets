...
#load data
train_x = torch.from_numpy(np.load('/Datasets/UCI/x_train.npy')).float()
train_y = torch.from_numpy(np.load('/Datasets/UCI/y_train.npy')).long()
test_x = torch.from_numpy(np.load('/Datasets/UCI/x_test.npy')).float()
test_y = torch.from_numpy(np.load('/Datasets/UCI/y_test.npy')).long()
