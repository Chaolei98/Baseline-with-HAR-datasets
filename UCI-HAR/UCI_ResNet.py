...
#load data
# train_x = torch.from_numpy(np.load('/data1/experiment/hcl/Datasets/UCI/x_train.npy')).float()
# train_y = torch.from_numpy(np.load('/data1/experiment/hcl/Datasets/UCI/y_train.npy')).long()
# test_x = torch.from_numpy(np.load('/data1/experiment/hcl/Datasets/UCI/x_test.npy')).float()
# test_y = torch.from_numpy(np.load('/data1/experiment/hcl/Datasets/UCI/y_test.npy')).long()
train_x = torch.from_numpy(np.load('/mnt/experiment/hcl/Datasets/UCI/x_train.npy')).float()
train_y = torch.from_numpy(np.load('/mnt/experiment/hcl/Datasets/UCI/y_train.npy')).long()
test_x = torch.from_numpy(np.load('/mnt/experiment/hcl/Datasets/UCI/x_test.npy')).float()
test_y = torch.from_numpy(np.load('/mnt/experiment/hcl/Datasets/UCI/y_test.npy')).long()
