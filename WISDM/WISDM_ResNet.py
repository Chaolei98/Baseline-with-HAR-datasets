...
#load data
train_x = torch.from_numpy(np.load('/Datasets/wisdm/x_train.npy')).float()
train_y = torch.from_numpy(np.load('/Datasets/wisdm/y_train.npy')).long()
test_x = torch.from_numpy(np.load('/Datasets/wisdm/x_test.npy')).float()
test_y = torch.from_numpy(np.load('/Datasets/wisdm/y_test.npy')).long()
